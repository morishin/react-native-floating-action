...
| distanceToEdge          | number                | 30                    | Distance from button to edges                                                                                       |
| horizontalDistanceToEdge| number                | use `distanceToEdge`  | Distance from button to horizontal edge                                                                             |
| verticalDistanceToEdge  | number                | use `distanceToEdge`  | Distance from button to vertical edge                                                                               |
